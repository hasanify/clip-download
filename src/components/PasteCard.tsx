...
export const PasteCard = ({ image }: PasteCardProps) => {
  ...
  return (
    <div 
      className="glass p-4 rounded-3xl w-full max-w-4xl mx-auto transition-all duration-500 shadow-2xl animate-in fade-in zoom-in duration-700"
      role="presentation"
    >
      <div className="relative rounded-2xl overflow-hidden border border-white/10 bg-black/40 shadow-inner">
        <img 
          src={image} 
          alt="Preview of the image captured from clipboard" 
